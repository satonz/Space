...
<html>
			...
			<div class="mainbar">
				<div class="page-head">
					...
					<div class="bread-crumb pull-right">
						...
						<a href="#" class="bread-current">二级评论</a>
					</div>
                    ...
                    -->
									...
									<div class="widget-content">
										<div class="padd">
											<div class="form quick-post">
												...
												<form class="form-horizontal" method="post" action="${ctx }/admin/reply/list">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="widget">
									<div class="widget-head">
										<div class="pull-left">二级评论列表</div>
										<div class="clearfix"></div>
									</div>
									...
									<div class="widget-content">
										...
										<table class="table table-striped table-bordered table-hover" style="table-layout: fixed;">
											...
											<c:forEach var="object" items="${list }">
												...
												<tr>
													...
													<td>
														<a onclick="deleteReply(this, ${object.id})" href="javascript:void(0)" class="btn btn-xs btn-danger"><i class="icon-remove"></i> </a>
													</td>
												</tr>
											</c:forEach>
										...
										<div class="widget-foot">
											<c:import url="page.jsp">
												<c:param name="url" value="${ctx }/admin/reply/list?retrieval=${retrieval }"></c:param>
											</c:import>
											<div class="clearfix"></div>
										</div>
									</div>
	...
	<script type="text/javascript">
		function deleteReply(element, id) {
			$.post("delete",
					{
						"id": id,
					},
