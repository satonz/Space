								...
								<div class="widget wgreen">
									...
									<div class="widget-content">
										<div class="padd">
											...
											<!-- Form starts.  -->
											<form class="form-horizontal" role="form" method="post" action="${ctx }/admin/updatePwd" >
												...
												<div class="form-group">
													...
													<div class="col-lg-8 col-md-8 col-xs-8">
														<input name="oldPwd" required="required" type="password" class="form-control" placeholder="旧密码">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-4 col-md-4 col-xs-4 control-label">新密码</label>
													<div class="col-lg-8 col-md-8 col-xs-8">
														<input type="password" required="required" class="form-control" placeholder="新密码">
													</div>
												</div>
												<div class="form-group">
													<label class="col-lg-4 col-md-4 col-xs-4 control-label">确认密码</label>
													<div class="col-lg-8 col-md-8 col-xs-8">
														<input name="newPwd" required="required" type="password" class="form-control" placeholder="确认密码">
													</div>
												</div>
